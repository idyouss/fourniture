...
public class AlertMaker {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(Utility.ICON_IMAGE_LOC));
            TrayIcon trayIcon = new TrayIcon(image, "Fourniture norsys");
            trayIcon.setImageAutoSize(true);
            trayIcon.setToolTip("Fourniture norsys");
            tray.add(trayIcon);
